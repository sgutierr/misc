...
function _M.load_configuration(client)
  ...
  local keycloak_config = {
    ...
    authorize_url = 'http://99f857a7.ngrok.io/openam/oauth2/realms/root/realms/3Scale/authorize',
    --token_url = resty_url.join(endpoint,'/protocol/openid-connect/token'),
    token_url = 'http://99f857a7.ngrok.io/openam/oauth2/realms/root/realms/3Scale/access_token', 
